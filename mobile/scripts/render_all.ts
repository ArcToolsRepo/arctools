...
const mods: Record<string, () => Promise<Record<string, unknown>>> = { Trending: () => import("../src/screens/Trending"), Token: () => import("../src/screens/Token"), Predict: () => import("../src/screens/Predict"), Market: () => import("../src/screens/Market"), Cross: () => import("../src/screens/Cross"), Wallet: () => import("../src/screens/Wallet"), Swap: () => import("../src/screens/Swap"), More: () => import("../src/screens/More"), Watch: () => import("../src/screens/Watch"), Sub: () => import("../src/screens/Sub"), Native: () => import("../src/screens/Native"), Launch: () => import("../src/screens/Launch"), Archy: () => import("../src/screens/Archy") };
const cases: [string, string, unknown][] = [["Trending","Trending",{}],["Predict","Predict",{}],["Market","Market",{}],["Cross","Cross",{}],["Token","Token",{ ca: ARCT }],["Wallet","Wallet",{}],["Swap","Swap",{}],["More","More",{}],["Watch","Watch",{}],["Launch","Launch",{}],["Archy","Archy",{}],["Native","Pay",{}],["Native","Referrals",{}],["Native","Bridge",{}],["Native","Trades",{}],["Native","Traders",{}]];
