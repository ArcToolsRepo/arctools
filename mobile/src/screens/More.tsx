...
const ITEMS: [string, string, keyof typeof Icon][] = [
  ...
  ["/alerts", "Alerts", "bell"], ["/launchpad", "Launch", "rocket"], ["/locker", "Locker", "lock"], ["/market", "Market", "gift"], ["/cross", "Buy from another chain", "link"], ["/predict", "Predict", "swap"], ["/pay", "Pay links", "link"],
