...
function Settings() {
  ...
  return (
    <>
      ...
      <div className="card muted" style={{ fontSize: 12.5 }}>ArcTools for Android v1.0 · arctools.fun · Fees fund ARCT buybacks that burn in the same transaction. Your key never leaves this phone. Internal review only — no third-party audit.</div>
    </>
  );
}
