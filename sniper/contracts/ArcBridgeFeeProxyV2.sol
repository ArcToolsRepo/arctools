...
contract ArcBridgeFeeProxyV2 {
    // Arc mainnet MessageTransmitterV2 (Circle deployed it at a chain-specific address here, NOT the canonical 0xE737…)
    ...
    constructor(address _transmitter, address _feeWallet, uint256 _feeBps) {
        require(_transmitter.code.length > 0, "transmitter has no code");
