...
export const Route = createFileRoute("/launchpad2")({
  head: () => ({
    meta: [
  ...
  if (done && done.startsWith("0x")) {
    return (
      <div style={{ border: "1px solid var(--arc-cobalt)", padding: 22 }}>
        ...
        <Link className="arc-cta" params={{ ca: done }} style={{ display: "inline-block", marginTop: 14, textDecoration: "none" }} to="/token2/$ca">
          Open token page
        </Link>
      </div>
    );
...
function LaunchpadPage() {
  ...
  return (
    <main className="arc-dsp" style={{ minHeight: "100dvh" }}>
      <DsRail />
      <section className="arc-dsp__body" style={{ maxWidth: 860, paddingTop: 130 }}>
        ...
        <p className="arc-body">
          ...
          curve. 5% of every launch is locked for <Link style={{ color: "var(--arc-cobalt)" }} to="/rewards2">ARCT stakers</Link>.
        </p>
