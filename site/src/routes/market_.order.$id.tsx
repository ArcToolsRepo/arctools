...
export const Route = createFileRoute("/market_/order/$id")({
  head: () => ({ meta: [
  ...
  component: () => {
    ...
    return (
      <main className="arc-site" style={{ minHeight: "100dvh" }}>
        ...
        <section className="arc-section" style={{ maxWidth: 1240, paddingTop: 112 }}><MarketContent initial={{ kind: "order", id: Number(id) }} /></section>
      </main>
    );
  },
});
