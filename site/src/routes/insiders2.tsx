...
export const Route = createFileRoute("/insiders2")({
  loader: async () => {
    try {
...
function InsidersPage() {
  ...
  return (
    <main className="arc-dsp" style={{ minHeight: "100dvh" }}>
      <DsRail />
      <section className="arc-dsp__body" style={{ maxWidth: 980, paddingTop: 130 }}>
        ...
        <p className="arc-body">
          ...
          <a href="/rewards2" style={{ color: "var(--arc-cobalt)" }}>/rewards</a>.
        </p>
