...
export const Route = createFileRoute("/pay2")({
  head: () => ({ meta: [
  ...
  if (done) return (
    <div style={{ ...box, border: "1px solid rgba(34,197,94,0.35)" }}>
      ...
      <div style={{ display: "flex", flexWrap: "wrap", gap: 8, marginTop: 14 }}>
        <a className="arc-cta" href="/trade2">Trade it in the Terminal</a>
        <a className="arc-cta" href="/pay2" style={{ background: "transparent", border: "1px solid var(--arc-line)", color: "var(--arc-ink)" }}>Send your own link</a>
      </div>
    </div>
  );
