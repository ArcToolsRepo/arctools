...
GIGS = {
 ...
 "sniper-onboarding": ("other", 25, 1, "Sniper bot onboarding call (auto-snipe rules, protection, copy-trade)", "A 45-minute call: wallet setup in @ArcSniper_bot, protection defaults, auto-snipe rules per launchpad, copy-trade, orders, and how fees work. Recorded for you. Same day or next.", ["https://t.me/ArcSniper_bot"], ["sniper", "onboarding"], (46, 124, 255)),
